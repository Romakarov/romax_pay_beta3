...
function App() {
  ...
  const handleTabChange = (tab: Tab) => {
    ...
    // Only reset to dashboard if NOT in payment flow
    if (tab === 'home') {
      // If user has a payment draft and is in pay view, preserve the wizard state
      if (paymentDraft && homeView === 'pay') {
        // Keep homeView='pay' to preserve wizard state
      } else {
